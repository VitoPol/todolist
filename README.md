...
Полноценный сервис для составления и отслеживания задач, готовый к разворачиванию на сервере. Также реализован телеграм-бот поддерживающий весь функционал сервиса (@ToDo_VitoBot).
